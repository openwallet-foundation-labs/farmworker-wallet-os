...
export async function jsa_aries_agent_oob_createInvitation(agent_key, domain, label, alias, imageUrl, goalCode, goal, handshake, handshakeProtocols, messages, multiUseInvitation, autoAcceptConnection, routing, appendedAttachments) {
	...
	try{
		...
		/*
		 * this configuration is currently causing issues
		 * todo: look into fixing this so that it does not cause issues
		 * the issue that was observed was a failure to establish a live connection from the test page
		 * this is also causing issues with sending messages
		 *
