 ...
 */
export async function jsa_aries_agent_modules_questionnaire_sendAnswer(agent_key, questionAnswerRecordId, response) {
	// BEGIN USER CODE
	try{
		...
		return Promise.resolve(JSON.stringify(
			await agent.modules.questionnaire.sendAnswer(questionAnswerRecordId,response)
		));
	}catch(e){
