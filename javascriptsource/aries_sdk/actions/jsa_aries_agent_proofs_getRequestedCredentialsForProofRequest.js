 ...
 */
export async function jsa_aries_agent_proofs_getRequestedCredentialsForProofRequest(agent_key, proofRecordId, config_filterByPresentationPreview, config_filterByNonRevocationRequirements) {
	// BEGIN USER CODE
	try{
