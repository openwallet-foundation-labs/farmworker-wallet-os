...
export interface QueryFeaturesOptions<DFSs extends DiscoverFeaturesService[] = DiscoverFeaturesService[]> extends BaseOptions {
...
export interface DiscloseFeaturesOptions<DFSs extends DiscoverFeaturesService[] = DiscoverFeaturesService[]> extends BaseOptions {
    protocolVersion: DiscoverFeaturesProtocolVersionType<DFSs>;
