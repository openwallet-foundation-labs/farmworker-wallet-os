...
import type { CredentialFormatsFromProtocols, DeleteCredentialOptions, GetCredentialFormatDataReturn } from './protocol/CredentialProtocolOptions';
 ...
 */
export interface CreateCredentialOfferOptions<CPs extends CredentialProtocol[] = CredentialProtocol[]> extends BaseOptions {
    protocolVersion: CredentialProtocolVersionType<CPs>;
    credentialFormats: CredentialFormatPayload<CredentialFormatsFromProtocols<CPs>, 'createOffer'>;
}
/**
 ...
 */
export interface OfferCredentialOptions<CPs extends CredentialProtocol[] = CredentialProtocol[]> extends BaseOptions, CreateCredentialOfferOptions<CPs> {
    connectionId: string;
}
/**
