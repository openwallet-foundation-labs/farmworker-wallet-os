...
export declare class V2CredentialProtocol<CFs extends CredentialFormatService[] = CredentialFormatService[]> extends BaseCredentialProtocol<CFs> implements CredentialProtocol<CFs> {
     ...
     *
     */
    createProblemReport(agentContext: AgentContext, { credentialRecord, description }: CreateCredentialProblemReportOptions): Promise<CredentialProtocolMsgReturnType<ProblemReportMessage>>;
