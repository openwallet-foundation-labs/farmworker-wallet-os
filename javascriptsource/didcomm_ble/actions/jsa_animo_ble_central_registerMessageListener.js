 ...
 */
export async function _jsa_animo_ble_central_registerMessageListener(callback, data_parameter_name) {
	// BEGIN USER CODE
	try{
		...
		return Promise.resolve(
			JSON.stringify(await central.registerMessageListener((data)=>{
				let args={};
