...
/**
 *  (method) Central.registerOnConnectedListener(cb: ({ identifier, name }: {
 *      identifier: string;
 *      name?: string;
 ...
 */
export async function _jsa_animo_ble_central_registerOnConnectedListener(agent_key, callback, identifier_parameter_name) {
	// BEGIN USER CODE
	try{
