 ...
 * @param {string} viewed_state
 * @returns {Promise.<void>}
 */
export async function jsa_aries_agent_modules_receipts_sendMessageViewedReceipt(agent_key, connectionId, messageId, viewed_state) {
	// BEGIN USER CODE
	try{
		...
		let options={
			connectionId: connectionId,
      		receipts: [{ messageId: messageId, state: viewed_state }]
		}
