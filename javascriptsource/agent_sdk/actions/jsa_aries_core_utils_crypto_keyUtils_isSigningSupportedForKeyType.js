...
// BEGIN EXTRA CODE
import { isSigningSupportedForKeyType } from '@credo-ts/core';
import { KeyType } from '@credo-ts/core';

// END EXTRA CODE

/**
 * function isSigningSupportedForKeyType(keyType: KeyType): boolean
 * 
 * https://github.com/openwallet-foundation/credo-ts/blob/59c7e15259af0d258cb07996d76cc0b2742c88ad/packages/core/src/crypto/keyUtils.ts#L37C17-L37C45
 ...
 */
export async function jsa_aries_core_utils_crypto_keyUtils_isSigningSupportedForKeyType(keyType) {
	// BEGIN USER CODE
	try{
		...
		return(Promise.resolve(isSigningSupportedForKeyType(keyType)));
	}catch(e){
