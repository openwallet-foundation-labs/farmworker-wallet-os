 ...
 *   threadId: string
 * 
 *   questionText: string // entidad: changed from questionanswer
 *   questionDetail?: string
 *   validResponses: ValidResponse[] // entidad: changed from questionanswer
 * 
 *   response?: string
 * }
 ...
 */
export async function jsa_aries_agent_modules_questionnaire_findAllByQuery(agent_key, query) {
	// BEGIN USER CODE
	try{
		...
		return Promise.resolve(JSON.stringify(
			await agent.modules.questionnaire.findAllByQuery(query)
		));
	}catch(e){
		return Promise.reject(e.toString());
	}
