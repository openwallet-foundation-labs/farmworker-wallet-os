...
export declare class V2ProofProtocol<PFs extends ProofFormatService[] = ProofFormatService[]> extends BaseProofProtocol implements ProofProtocol<PFs> {
    ...
    createProposal(agentContext: AgentContext, { connectionRecord, proofFormats, comment, autoAcceptProof, goalCode, parentThreadId, }: CreateProofProposalOptions<PFs>): Promise<{
    ...
    acceptProposal(agentContext: AgentContext, { proofRecord, proofFormats, autoAcceptProof, comment, goalCode, willConfirm }: AcceptProofProposalOptions<PFs>): Promise<ProofProtocolMsgReturnType<V2RequestPresentationMessage>>;
    /**
     ...
     *
     */
    negotiateProposal(agentContext: AgentContext, { proofRecord, proofFormats, autoAcceptProof, comment, goalCode, willConfirm }: NegotiateProofProposalOptions<PFs>): Promise<ProofProtocolMsgReturnType<V2RequestPresentationMessage>>;
    /**
     * Create a {@link V2RequestPresentationMessage} as beginning of protocol process.
     * @returns Object containing request message and associated credential record
     *
     */
    createRequest(agentContext: AgentContext, { proofFormats, autoAcceptProof, comment, connectionRecord, parentThreadId, goalCode, willConfirm, }: CreateProofRequestOptions<PFs>): Promise<ProofProtocolMsgReturnType<V2RequestPresentationMessage>>;
    /**
    ...
    acceptRequest(agentContext: AgentContext, { proofRecord, autoAcceptProof, comment, proofFormats, goalCode }: AcceptProofRequestOptions<PFs>): Promise<{
        proofRecord: ProofExchangeRecord;
     ...
     *
     */
    negotiateRequest(agentContext: AgentContext, { proofRecord, proofFormats, autoAcceptProof, comment, goalCode }: NegotiateProofRequestOptions<PFs>): Promise<ProofProtocolMsgReturnType<V2ProposeCredentialMessage>>;
    ...
    createProblemReport(agentContext: AgentContext, { description, proofRecord }: CreateProofProblemReportOptions): Promise<ProofProtocolMsgReturnType<ProblemReportMessage>>;
