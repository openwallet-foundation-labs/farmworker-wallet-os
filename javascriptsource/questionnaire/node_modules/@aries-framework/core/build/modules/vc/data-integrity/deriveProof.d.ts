 ...
 */
export declare const deriveProof: (proofDocument: JsonObject, revealDocument: JsonObject, { suite, skipProofCompaction, documentLoader, expansionMap, nonce }: any) => Promise<W3cJsonLdVerifiableCredential>;
