 ...
 */
export async function jsa_ios_deleteAllItems(keychainService, touchID, kSecAccessControl, kSecAttrSynchronizable, kLocalizedFallbackTitle, kSecUseOperationPrompt) {
	// BEGIN USER CODE
