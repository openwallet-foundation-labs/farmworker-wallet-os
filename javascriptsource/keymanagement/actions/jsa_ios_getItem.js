 ...
 */
export async function jsa_ios_getItem(key, keychainService, touchID, kSecAccessControl, kSecAttrSynchronizable, kLocalizedFallbackTitle, kSecUseOperationPrompt) {
	// BEGIN USER CODE
	return new Promise(async(resolve,reject)=>{
		try{
			let settings={};
			if(typeof(keychainService)&&keychainService!=null)settings.keychainService=keychainService;
			...
			const value=await SInfo.getItem(key,settings);
			resolve(
					value==null?
						null
					:
