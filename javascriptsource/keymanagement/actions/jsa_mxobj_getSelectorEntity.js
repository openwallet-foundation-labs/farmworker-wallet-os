 ...
 * See:
 * 
 *         mendix/lib/MxMetaObject#getSelectorEntity
 * 
 * Example
 * 
 ...
 */
export async function jsa_mxobj_getSelectorEntity(input, attribute) {
	// BEGIN USER CODE
	try{
		if(input==null)return Promise.reject("Invalid argument input");
		//todo:handle return type serialization
		return Promise.resolve(input.getSelectorEntity(attribute));
	}catch(e){
