 ...
 */
export async function jsa_android_deleteItem(key, sharedPreferencesName, touchID, showModal, strings_header, strings_description, strings_hint, strings_success, strings_notRecognized, strings_cancel, strings_cancelled, setInvalidatedByBiometricEnrollment) {
	// BEGIN USER CODE
