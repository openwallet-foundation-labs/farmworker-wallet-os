...
/**
 * https://mcodex.dev/react-native-sensitive-info/docs/deleteItem
 ...
 */
export async function jsa_android_deleteAllItems(sharedPreferencesName, touchID, showModal, strings_header, strings_description, strings_hint, strings_success, strings_notRecognized, strings_cancel, strings_cancelled, setInvalidatedByBiometricEnrollment) {
	// BEGIN USER CODE
