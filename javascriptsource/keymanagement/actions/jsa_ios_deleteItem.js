 ...
 */
export async function jsa_ios_deleteItem(key, keychainService, touchID, kSecAccessControl, kSecAttrSynchronizable, kLocalizedFallbackTitle, kSecUseOperationPrompt) {
	// BEGIN USER CODE
