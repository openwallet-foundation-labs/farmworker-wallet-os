...
var jsigs = require('@digitalcredentials/jsonld-signatures');
var ed25519VerificationKey2020 = require('@digitalcredentials/ed25519-verification-key-2020');
var suiteContext2020 = require('ed25519-signature-2020-context');
var suiteContext2018 = require('ed25519-signature-2018-context');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var jsigs__default = /*#__PURE__*/_interopDefaultLegacy(jsigs);
var suiteContext2020__default = /*#__PURE__*/_interopDefaultLegacy(suiteContext2020);
var suiteContext2018__default = /*#__PURE__*/_interopDefaultLegacy(suiteContext2018);

/*!
 * Copyright (c) 2020-2021 Digital Bazaar, Inc. All rights reserved.
 */
const {suites: {LinkedDataSignature}} = jsigs__default['default'];
const base58btc = require('@digitalcredentials/base58-universal');

// 'https://w3id.org/security/suites/ed25519-2020/v1'
const SUITE_CONTEXT_URL = suiteContext2020__default['default'].constants.CONTEXT_URL;
// 'https://w3id.org/security/suites/ed25519-2018/v1'
const SUITE_CONTEXT_URL_2018 = suiteContext2018__default['default'].constants.CONTEXT_URL;
...
class Ed25519Signature2020 extends LinkedDataSignature {
  ...
  constructor({
    ...
    super({
      type: 'Ed25519Signature2020', LDKeyClass: ed25519VerificationKey2020.Ed25519VerificationKey2020,
  ...
  async getVerificationMethod({proof, documentLoader}) {
    ...
    if(verificationMethod.type === 'Ed25519VerificationKey2018') {
      verificationMethod = (await ed25519VerificationKey2020.Ed25519VerificationKey2020
...
Ed25519Signature2020.CONTEXT = suiteContext2020__default['default'].contexts.get(SUITE_CONTEXT_URL);
