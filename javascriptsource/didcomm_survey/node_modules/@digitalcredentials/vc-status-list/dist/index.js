...
var credentialsCtx = require('credentials-context');
var StatusList = require('./StatusList.js');
var vc = require('@digitalcredentials/vc');
var statusListCtx = require('@digitalbazaar/vc-status-list-context');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var credentialsCtx__default = /*#__PURE__*/_interopDefaultLegacy(credentialsCtx);
var statusListCtx__default = /*#__PURE__*/_interopDefaultLegacy(statusListCtx);

/*!
 * Copyright (c) 2022 Digital Bazaar, Inc. All rights reserved.
 */

const VC_V1_CONTEXT_URL = credentialsCtx__default["default"].constants.CREDENTIALS_CONTEXT_V1_URL;
const SL_V1_CONTEXT_URL = statusListCtx__default["default"].constants.CONTEXT_URL_V1;

async function createList({length}) {
  return new StatusList.StatusList({length});
}

async function decodeList({encodedList}) {
  return StatusList.StatusList.decode({encodedList});
}
 ...
 */
async function createCredential({id, list, statusPurpose}) {
...
function assertStatusList2021Context({credential} = {}) {
  _isObject({credential});
  // check for expected contexts
  const {'@context': contexts} = credential;
  if(!Array.isArray(contexts)) {
 ...
 */
function getCredentialStatus({credential, statusPurpose} = {}) {
  _isObject({credential});
...
exports.StatusList = StatusList.StatusList;
exports.assertStatusList2021Context = assertStatusList2021Context;
