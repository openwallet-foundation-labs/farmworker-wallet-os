    ...
    services.forEach((service, index) => {
        ...
        const recipientKeys = service.recipientKeys.map((recipientKey) => {
            ...
            if (recipientKey.keyType !== KeyType_1.KeyType.Ed25519) {
                throw new error_1.CredoError(`Unable to create did document from services. recipient key type ${recipientKey.keyType} is not supported. Supported key types are ${KeyType_1.KeyType.Ed25519}`);
            }
