...
class OutOfBandInvitation extends AgentMessage_1.AgentMessage {
    ...
    static fromUrl(invitationUrl) {
        ...
        if (typeof encodedInvitation === 'string') {
            ...
            throw new error_1.CredoError('InvitationUrl is invalid. It needs to contain one, and only one, of the following parameters; `oob`');
        }
    }
...
], OutOfBandInvitation.prototype, "invitationType", void 0);
__decorate([
