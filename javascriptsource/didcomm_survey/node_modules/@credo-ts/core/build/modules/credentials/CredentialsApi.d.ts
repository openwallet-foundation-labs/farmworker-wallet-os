...
export declare class CredentialsApi<CPs extends CredentialProtocol[]> implements CredentialsApi<CPs> {
    ...
    private revocationNotificationService;
    private routingService;
    private logger;
    constructor(messageSender: MessageSender, connectionService: ConnectionService, agentContext: AgentContext, logger: Logger, credentialRepository: CredentialRepository, mediationRecipientService: RoutingService, didCommMessageRepository: DidCommMessageRepository, revocationNotificationService: RevocationNotificationService, config: CredentialsModuleConfig<CPs>);
    private getProtocol;
