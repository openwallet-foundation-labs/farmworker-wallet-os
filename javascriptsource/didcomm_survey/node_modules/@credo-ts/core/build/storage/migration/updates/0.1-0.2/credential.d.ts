...
export declare enum V01_02MigrationCredentialRole {
    Issuer = 0,
    Holder = 1
}
export declare function getCredentialRole(credentialRecord: CredentialExchangeRecord): V01_02MigrationCredentialRole;
/**
