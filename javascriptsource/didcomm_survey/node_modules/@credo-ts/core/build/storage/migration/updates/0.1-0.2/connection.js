...
const peerDidNumAlgo2_1 = require("../../../..//modules/dids/methods/peer/peerDidNumAlgo2");
...
async function migrateToOobRecord(agent, connectionRecord) {
    ...
    if (oldInvitationJson) {
        ...
        const [invitationDid] = [
            ...
            ...oobRecord.outOfBandInvitation.getInlineServices().map(peerDidNumAlgo2_1.outOfBandServiceToInlineKeysNumAlgo2Did),
        ];
