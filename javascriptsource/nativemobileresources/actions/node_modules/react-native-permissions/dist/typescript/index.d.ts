...
export declare const request: (permission: import("./types").Permission, rationale?: import("react-native/Libraries/PermissionsAndroid/PermissionsAndroid").Rationale | (() => Promise<boolean>) | undefined) => Promise<import("./types").PermissionStatus>;
=======
export declare const openLimitedPhotoLibraryPicker: () => Promise<void>;
export declare const openSettings: () => Promise<void>;
export declare const request: (permission: import("./types").Permission, rationale?: import("react-native").Rationale | undefined) => Promise<import("./types").PermissionStatus>;
...
<<<<<<< HEAD
    ...
    request: (permission: import("./types").Permission, rationale?: import("react-native/Libraries/PermissionsAndroid/PermissionsAndroid").Rationale | (() => Promise<boolean>) | undefined) => Promise<import("./types").PermissionStatus>;
=======
    openLimitedPhotoLibraryPicker: () => Promise<void>;
    openSettings: () => Promise<void>;
    request: (permission: import("./types").Permission, rationale?: import("react-native").Rationale | undefined) => Promise<import("./types").PermissionStatus>;
>>>>>>> aec85746435d3ba41358c5b7d65f93f87448e5b8
    requestLocationAccuracy: (options: import("./types").LocationAccuracyOptions) => Promise<import("./types").LocationAccuracy>;
    requestMultiple: <P_1 extends import("./types").Permission[]>(permissions: P_1) => Promise<Record<P_1[number], import("./types").PermissionStatus>>;
